...
otcdocs_repo_name = 'opentelekomcloud-docs/cloud-container-instance'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/cloud-container-instance/api-ref/'
...
html_title = "Cloud Container Instance - API Reference"
...
latex_documents = [
    ('index',
     'cci-api-ref.tex',
     u'Cloud Container Instance - API Reference',
